...
I wasn't selected for the internship (there were only three engineering positions), but I managed to make it **to the final interview** with only a few other candidates from over more than 2000 candidates, and that is a **huge achievement** for me. I learned a lot, and I'm proud of myself.
...
Here is a preview of my final cover letter:
...
In the beginning, I was surprised, because I applied for the SIP role, and I was expecting some hard tasks with Redis, MySQL, maybe some Docker, task queues, rate limiting, etc. I was expecting something very hard, and I was prepared for the worst and the hardest task.
...
During this conversation, I was surprised that they didn't ask me about any technical things, those that I was prepared for (programming, oop, data structures, computer networks, plain Ruby, databases, git, frontend, infrastructure, security). I could expect that, because they mentioned in the job offer, they are avoiding some brainteasers, whiteboards, or gotchas during technical interviews.

The recruitment task was diverse and certainly showed a way of thinking, and maybe that was all they needed. However, as a candidate, you could have not known anything beyond the selected code parts. As we know, Rails are so specific that you can know nothing about them and still copy-paste code snippets from the internet and it will work somehow.
